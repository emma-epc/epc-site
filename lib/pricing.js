...
export const PRICING = {
  ...
  "Création de sites web": {
    intro: "Des sites codés sur-mesure (comme celui que vous parcourez) : rapides, optimisés et pensés pour convertir. Selon le projet, vous gérez vos contenus en autonomie ou je m'occupe des mises à jour.",
    disclaimer:
    ...
    groups: [
      {
        name: "Formule", type: "radio",
        options: [
          { label: "Site essentiel", price: 1900, unit: "projet", from: true, note: "jusqu'à 5 pages, codé sur-mesure, rapide et optimisé SEO" },
          { label: "Site sur-mesure", price: 3500, unit: "projet", from: true, note: "design et développement sur-mesure, arborescence étendue, fonctionnalités avancées" },
        ],
      },
      {
        name: "Options", type: "check",
